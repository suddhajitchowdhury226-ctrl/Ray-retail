import{ab as e,h as t,i as a,U as r}from"./ui-vendor-RnvF1760.js";import{h as s,k as o}from"./react-vendor-RVvZPAlq.js";import{a as i}from"./utils-CyEmLjAX.js";const n="/assets/BlogBgImg1-CuVSza68.jpg";let l,c,d,p={data:""},m=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,u=/\/\*[^]*?\*\/|  +/g,g=/\n+/g,h=(e,t)=>{let a="",r="",s="";for(let o in e){let i=e[o];"@"==o[0]?"i"==o[1]?a=o+" "+i+";":r+="f"==o[1]?h(i,o):o+"{"+h(i,"k"==o[1]?"":t)+"}":"object"==typeof i?r+=h(i,t?t.replace(/([^,])+/g,e=>o.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,t=>/&/.test(t)?t.replace(/&/g,e):e?e+" "+t:t)):o):null!=i&&(o="-"==o[1]?o:o.replace(/[A-Z]/g,"-$&").toLowerCase(),s+=h.p?h.p(o,i):o+":"+i+";")}return a+(t&&s?t+"{"+s+"}":s)+r},f={},x=e=>{if("object"==typeof e){let t="";for(let a in e)t+=a+x(e[a]);return t}return e};function y(e){let t=this||{},a=e.call?e(t.p):e;return((e,t,a,r,s)=>{let o=x(e),i=f[o]||(f[o]=(e=>{let t=0,a=11;for(;t<e.length;)a=101*a+e.charCodeAt(t++)>>>0;return"go"+a})(o));if(!f[i]){let t=o!==e?e:(e=>{let t,a,r=[{}];for(;t=m.exec(e.replace(u,""));)t[4]?r.shift():t[3]?(a=t[3].replace(g," ").trim(),r.unshift(r[0][a]=r[0][a]||{})):r[0][t[1]]=t[2].replace(g," ").trim();return r[0]})(e);f[i]=h(s?{["@keyframes "+i]:t}:t,a?"":"."+i)}let n=a&&f.g;return a&&(f.g=f[i]),l=f[i],c=t,d=r,(p=n)?c.data=c.data.replace(p,l):-1===c.data.indexOf(l)&&(c.data=d?l+c.data:c.data+l),i;var l,c,d,p})(a.unshift?a.raw?((e,t,a)=>e.reduce((e,r,s)=>{let o=t[s];if(o&&o.call){let e=o(a),t=e&&e.props&&e.props.className||/^go/.test(e)&&e;o=t?"."+t:e&&"object"==typeof e?e.props?"":h(e,""):!1===e?"":e}return e+r+(null==o?"":o)},""))(a,[].slice.call(arguments,1),t.p):a.reduce((e,a)=>Object.assign(e,a&&a.call?a(t.p):a),{}):a,(e=>{if("object"==typeof window){let t=(e?e.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return t.nonce=window.__nonce__,t.parentNode||(e||document.head).appendChild(t),t.firstChild}return e||p})(t.target),t.g,t.o,t.k)}y.bind({g:1});let b=y.bind({k:1});function v(e,t){let a=this||{};return function(){let t=arguments;return function r(s,o){let i=Object.assign({},s),n=i.className||r.className;a.p=Object.assign({theme:c&&c()},i),a.o=/go\d/.test(n),i.className=y.apply(a,t)+(n?" "+n:"");let p=e;return e[0]&&(p=i.as||e,delete i.as),d&&p[0]&&d(i),l(p,i)}}}var j=(e,t)=>(e=>"function"==typeof e)(e)?e(t):e,w=(()=>{let e=0;return()=>(++e).toString()})(),N=(()=>{let e;return()=>{if(void 0===e&&typeof window<"u"){let t=matchMedia("(prefers-reduced-motion: reduce)");e=!t||t.matches}return e}})(),_="default",k=(e,t)=>{let{toastLimit:a}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,a)};case 1:return{...e,toasts:e.toasts.map(e=>e.id===t.toast.id?{...e,...t.toast}:e)};case 2:let{toast:r}=t;return k(e,{type:e.toasts.find(e=>e.id===r.id)?1:0,toast:r});case 3:let{toastId:s}=t;return{...e,toasts:e.toasts.map(e=>e.id===s||void 0===s?{...e,dismissed:!0,visible:!1}:e)};case 4:return void 0===t.toastId?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(e=>e.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let o=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(e=>({...e,pauseDuration:e.pauseDuration+o}))}}},$=[],E={toasts:[],pausedAt:void 0,settings:{toastLimit:20}},B={},C=(e,t=_)=>{B[t]=k(B[t]||E,e),$.forEach(([e,a])=>{e===t&&a(B[t])})},S=e=>Object.keys(B).forEach(t=>C(e,t)),W=(e=_)=>t=>{C(t,e)},z=e=>(t,a)=>{let r=((e,t="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...a,id:(null==a?void 0:a.id)||w()}))(t,e,a);return W(r.toasterId||(e=>Object.keys(B).find(t=>B[t].toasts.some(t=>t.id===e)))(r.id))({type:2,toast:r}),r.id},A=(e,t)=>z("blank")(e,t);A.error=z("error"),A.success=z("success"),A.loading=z("loading"),A.custom=z("custom"),A.dismiss=(e,t)=>{let a={type:3,toastId:e};t?W(t)(a):S(a)},A.dismissAll=e=>A.dismiss(void 0,e),A.remove=(e,t)=>{let a={type:4,toastId:e};t?W(t)(a):S(a)},A.removeAll=e=>A.remove(void 0,e),A.promise=(e,t,a)=>{let r=A.loading(t.loading,{...a,...null==a?void 0:a.loading});return"function"==typeof e&&(e=e()),e.then(e=>{let s=t.success?j(t.success,e):void 0;return s?A.success(s,{id:r,...a,...null==a?void 0:a.success}):A.dismiss(r),e}).catch(e=>{let s=t.error?j(t.error,e):void 0;s?A.error(s,{id:r,...a,...null==a?void 0:a.error}):A.dismiss(r)}),e};var I,M,L,F,O=b`
from {
...
to {
  ...
  animation: ${X} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Z=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?s.createElement(Y,null,t):t:"blank"===a?null:s.createElement(K,null,s.createElement(H,{...r}),"loading"!==a&&s.createElement(G,null,"error"===a?s.createElement(T,{...r}):s.createElement(q,{...r})))},J=e=>`\n0% {transform: translate3d(0,${-200*e}%,0) scale(.6); opacity:.5;}\n100% {transform: translate3d(0,0,0) scale(1); opacity:1;}\n`,Q=e=>`\n0% {transform: translate3d(0,0,-1px) scale(1); opacity:1;}\n100% {transform: translate3d(0,${-150*e}%,-1px) scale(.6); opacity:0;}\n`,ee=v("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
